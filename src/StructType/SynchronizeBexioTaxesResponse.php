...
/**
 * This class stands for SynchronizeBexioTaxesResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SynchronizeBexioTaxesResponse extends AbstractStructBase
{
    /**
     * The Created
     * @var int|null
    ...
    /**
     * Constructor method for SynchronizeBexioTaxesResponse
     * @uses SynchronizeBexioTaxesResponse::setCreated()
     * @uses SynchronizeBexioTaxesResponse::setModified()
     * @uses SynchronizeBexioTaxesResponse::setDeactivated()
     * @uses SynchronizeBexioTaxesResponse::setDeleted()
     * @param int $created
     * @param int $modified
     ...
     * Set Created value
     * @param int $created
     * @return \Pggns\MidocoApi\Crm\StructType\SynchronizeBexioTaxesResponse
     */
