...
/**
 * This class stands for PrepareUmbrellaSettlementsResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PrepareUmbrellaSettlementsResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for PrepareUmbrellaSettlementsResponse
     * @uses PrepareUmbrellaSettlementsResponse::setSettlementMonthID()
     * @uses PrepareUmbrellaSettlementsResponse::setUmbrellaSettlementDate()
     * @uses PrepareUmbrellaSettlementsResponse::setUmbrellaSettlementMessage()
     ...
     * @param int $settlementMonthID
     * @return \Pggns\MidocoApi\Crm\StructType\PrepareUmbrellaSettlementsResponse
     */
    ...
    public static function validateUmbrellaSettlementMessageForArrayConstraintFromSetUmbrellaSettlementMessage(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem) {
            // validation for constraint: itemType
            if (!$prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem instanceof \Pggns\MidocoApi\Crm\StructType\UmbrellaSettlementMessage) {
                $invalidValues[] = is_object($prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem) ? get_class($prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem) : sprintf('%s(%s)', gettype($prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem), var_export($prepareUmbrellaSettlementsResponseUmbrellaSettlementMessageItem, true));
            }
        }
