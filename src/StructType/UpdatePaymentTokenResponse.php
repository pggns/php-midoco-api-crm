...
/**
 * This class stands for UpdatePaymentTokenResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdatePaymentTokenResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for UpdatePaymentTokenResponse
     * @uses UpdatePaymentTokenResponse::setMidocoPaymentToken()
     * @uses UpdatePaymentTokenResponse::setMidocoPaymentTokenAttrib()
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\PaymentTokenDTO $midocoPaymentToken
     * @return \Pggns\MidocoApi\Crm\StructType\UpdatePaymentTokenResponse
     */
    ...
    public static function validateMidocoPaymentTokenAttribForArrayConstraintFromSetMidocoPaymentTokenAttrib(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $updatePaymentTokenResponseMidocoPaymentTokenAttribItem) {
            // validation for constraint: itemType
            if (!$updatePaymentTokenResponseMidocoPaymentTokenAttribItem instanceof \Pggns\MidocoApi\Crm\StructType\PaymentTokenAttribDTO) {
                $invalidValues[] = is_object($updatePaymentTokenResponseMidocoPaymentTokenAttribItem) ? get_class($updatePaymentTokenResponseMidocoPaymentTokenAttribItem) : sprintf('%s(%s)', gettype($updatePaymentTokenResponseMidocoPaymentTokenAttribItem), var_export($updatePaymentTokenResponseMidocoPaymentTokenAttribItem, true));
            }
        }
