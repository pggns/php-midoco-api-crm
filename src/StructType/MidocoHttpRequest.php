...
class MidocoHttpRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader[]
     */
     ...
     * @var \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter[]
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter[] $midocoHttpParameter
     ...
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader[]
     */
    ...
    public static function validateMidocoHttpHeaderForArrayConstraintFromSetMidocoHttpHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpHeaderItem) {
            ...
            if (!$midocoHttpRequestMidocoHttpHeaderItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoHttpRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader $item
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpHeader(\Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoHttpHeader, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter[]
     */
    ...
    public static function validateMidocoHttpParameterForArrayConstraintFromSetMidocoHttpParameter(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpParameterItem) {
            // validation for constraint: itemType
            if (!$midocoHttpRequestMidocoHttpParameterItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter $item
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpParameter(\Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoHttpParameter, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
