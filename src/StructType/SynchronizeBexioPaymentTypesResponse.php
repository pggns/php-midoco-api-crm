...
/**
 * This class stands for SynchronizeBexioPaymentTypesResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SynchronizeBexioPaymentTypesResponse extends AbstractStructBase
{
    /**
     * The Created
     * @var int|null
    ...
    /**
     * Constructor method for SynchronizeBexioPaymentTypesResponse
     * @uses SynchronizeBexioPaymentTypesResponse::setCreated()
     * @uses SynchronizeBexioPaymentTypesResponse::setModified()
     * @uses SynchronizeBexioPaymentTypesResponse::setDeleted()
     * @param int $created
     * @param int $modified
     * @param int $deleted
     */
     ...
     * Set Created value
     * @param int $created
     * @return \Pggns\MidocoApi\Crm\StructType\SynchronizeBexioPaymentTypesResponse
     */
