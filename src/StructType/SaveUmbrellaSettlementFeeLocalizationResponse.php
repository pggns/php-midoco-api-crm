...
/**
 * This class stands for SaveUmbrellaSettlementFeeLocalizationResponse StructType
 * Meta information extracted from the WSDL
 * - documentation: Returns all localizations for the UmbrellaSettlementFeeDefinition for which the localization was saved.<br> <em>This helps in keeping the GUI up to date and while reducing the number of requests the backend has to handle.</em>
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveUmbrellaSettlementFeeLocalizationResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SaveUmbrellaSettlementFeeLocalizationResponse
     * @uses SaveUmbrellaSettlementFeeLocalizationResponse::setMidocoUmbrellaSettlementFeeLocalization()
    ...
    public static function validateMidocoUmbrellaSettlementFeeLocalizationForArrayConstraintFromSetMidocoUmbrellaSettlementFeeLocalization(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem) {
            // validation for constraint: itemType
            if (!$saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem instanceof \Pggns\MidocoApi\Crm\StructType\UmbrellaSettlementFeeLocalizationDTO) {
                $invalidValues[] = is_object($saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem) ? get_class($saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem) : sprintf('%s(%s)', gettype($saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem), var_export($saveUmbrellaSettlementFeeLocalizationResponseMidocoUmbrellaSettlementFeeLocalizationItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\UmbrellaSettlementFeeLocalizationDTO[] $midocoUmbrellaSettlementFeeLocalization
     * @return \Pggns\MidocoApi\Crm\StructType\SaveUmbrellaSettlementFeeLocalizationResponse
     */
