...
/**
 * This class stands for SearchPaymentTokenRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SearchPaymentTokenRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SearchPaymentTokenRequest
     * @uses SearchPaymentTokenRequest::setMidocoPaymentToken()
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\PaymentTokenDTO $midocoPaymentToken
     * @return \Pggns\MidocoApi\Crm\StructType\SearchPaymentTokenRequest
     */
