...
/**
 * This class stands for DeleteAutoPrintSettingRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteAutoPrintSettingRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for DeleteAutoPrintSettingRequest
     * @uses DeleteAutoPrintSettingRequest::setMidocoAutoPrintSetting()
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoAutoPrintSetting $midocoAutoPrintSetting
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteAutoPrintSettingRequest
     */
