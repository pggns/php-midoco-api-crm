...
/**
 * This class stands for SynchronizeBexioCurrenciesResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SynchronizeBexioCurrenciesResponse extends AbstractStructBase
{
    /**
     * The Created
     * @var int|null
    ...
    /**
     * Constructor method for SynchronizeBexioCurrenciesResponse
     * @uses SynchronizeBexioCurrenciesResponse::setCreated()
     * @uses SynchronizeBexioCurrenciesResponse::setModified()
     * @uses SynchronizeBexioCurrenciesResponse::setDeleted()
     * @param int $created
     * @param int $modified
     * @param int $deleted
     */
     ...
     * Set Created value
     * @param int $created
     * @return \Pggns\MidocoApi\Crm\StructType\SynchronizeBexioCurrenciesResponse
     */
