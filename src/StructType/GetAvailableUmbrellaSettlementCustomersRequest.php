...
/**
 * This class stands for GetAvailableUmbrellaSettlementCustomersRequest StructType
 * Meta information extracted from the WSDL
 * - documentation: Request customers that can and will be added to the UmbrellaSettlementMonth when it is saved.<br> Customers can be added to and removed from the settlement later.
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetAvailableUmbrellaSettlementCustomersRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetAvailableUmbrellaSettlementCustomersRequest
     * @uses GetAvailableUmbrellaSettlementCustomersRequest::setUmbrellaSettlementDate()
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\UmbrellaSettlementDate $umbrellaSettlementDate
     * @return \Pggns\MidocoApi\Crm\StructType\GetAvailableUmbrellaSettlementCustomersRequest
     */
