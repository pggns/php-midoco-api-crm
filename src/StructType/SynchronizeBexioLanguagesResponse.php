...
/**
 * This class stands for SynchronizeBexioLanguagesResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SynchronizeBexioLanguagesResponse extends AbstractStructBase
{
    /**
     * The Created
     * @var int|null
    ...
    /**
     * Constructor method for SynchronizeBexioLanguagesResponse
     * @uses SynchronizeBexioLanguagesResponse::setCreated()
     * @uses SynchronizeBexioLanguagesResponse::setModified()
     * @uses SynchronizeBexioLanguagesResponse::setDeleted()
     * @param int $created
     * @param int $modified
     * @param int $deleted
     */
     ...
     * Set Created value
     * @param int $created
     * @return \Pggns\MidocoApi\Crm\StructType\SynchronizeBexioLanguagesResponse
     */
