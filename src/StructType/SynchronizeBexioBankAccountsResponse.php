...
/**
 * This class stands for SynchronizeBexioBankAccountsResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SynchronizeBexioBankAccountsResponse extends AbstractStructBase
{
    /**
     * The Created
     * @var int|null
    ...
    /**
     * Constructor method for SynchronizeBexioBankAccountsResponse
     * @uses SynchronizeBexioBankAccountsResponse::setCreated()
     * @uses SynchronizeBexioBankAccountsResponse::setModified()
     * @uses SynchronizeBexioBankAccountsResponse::setDeleted()
     * @param int $created
     * @param int $modified
     * @param int $deleted
     */
     ...
     * Set Created value
     * @param int $created
     * @return \Pggns\MidocoApi\Crm\StructType\SynchronizeBexioBankAccountsResponse
     */
