...
/**
 * This class stands for DeleteUmbrellaSettlementsRequest StructType
 * Meta information extracted from the WSDL
 * - documentation: Delete prepared settlements of the given settlement month.
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteUmbrellaSettlementsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for DeleteUmbrellaSettlementsRequest
     * @uses DeleteUmbrellaSettlementsRequest::setSettlementMonthID()
     * @uses DeleteUmbrellaSettlementsRequest::setCustomerID()
     ...
     * @param int $settlementMonthID
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteUmbrellaSettlementsRequest
     */
    ...
    public static function validateCustomerIDForArrayConstraintFromSetCustomerID(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deleteUmbrellaSettlementsRequestCustomerIDItem) {
            // validation for constraint: itemType
            if (!(is_int($deleteUmbrellaSettlementsRequestCustomerIDItem) || ctype_digit($deleteUmbrellaSettlementsRequestCustomerIDItem))) {
                $invalidValues[] = is_object($deleteUmbrellaSettlementsRequestCustomerIDItem) ? get_class($deleteUmbrellaSettlementsRequestCustomerIDItem) : sprintf('%s(%s)', gettype($deleteUmbrellaSettlementsRequestCustomerIDItem), var_export($deleteUmbrellaSettlementsRequestCustomerIDItem, true));
            }
        }
