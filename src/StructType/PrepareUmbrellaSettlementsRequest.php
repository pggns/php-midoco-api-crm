...
/**
 * This class stands for PrepareUmbrellaSettlementsRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PrepareUmbrellaSettlementsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for PrepareUmbrellaSettlementsRequest
     * @uses PrepareUmbrellaSettlementsRequest::setSettlementMonthID()
     * @uses PrepareUmbrellaSettlementsRequest::setCustomerID()
     ...
     * @param int $settlementMonthID
     * @return \Pggns\MidocoApi\Crm\StructType\PrepareUmbrellaSettlementsRequest
     */
    ...
    public static function validateCustomerIDForArrayConstraintFromSetCustomerID(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $prepareUmbrellaSettlementsRequestCustomerIDItem) {
            // validation for constraint: itemType
            if (!(is_int($prepareUmbrellaSettlementsRequestCustomerIDItem) || ctype_digit($prepareUmbrellaSettlementsRequestCustomerIDItem))) {
                $invalidValues[] = is_object($prepareUmbrellaSettlementsRequestCustomerIDItem) ? get_class($prepareUmbrellaSettlementsRequestCustomerIDItem) : sprintf('%s(%s)', gettype($prepareUmbrellaSettlementsRequestCustomerIDItem), var_export($prepareUmbrellaSettlementsRequestCustomerIDItem, true));
            }
        }
