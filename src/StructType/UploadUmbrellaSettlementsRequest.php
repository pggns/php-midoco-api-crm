...
/**
 * This class stands for UploadUmbrellaSettlementsRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UploadUmbrellaSettlementsRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for UploadUmbrellaSettlementsRequest
     * @uses UploadUmbrellaSettlementsRequest::setSettlementMonthID()
     * @uses UploadUmbrellaSettlementsRequest::setCustomerID()
     ...
     * @param int $settlementMonthID
     * @return \Pggns\MidocoApi\Crm\StructType\UploadUmbrellaSettlementsRequest
     */
    ...
    public static function validateCustomerIDForArrayConstraintFromSetCustomerID(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $uploadUmbrellaSettlementsRequestCustomerIDItem) {
            // validation for constraint: itemType
            if (!(is_int($uploadUmbrellaSettlementsRequestCustomerIDItem) || ctype_digit($uploadUmbrellaSettlementsRequestCustomerIDItem))) {
                $invalidValues[] = is_object($uploadUmbrellaSettlementsRequestCustomerIDItem) ? get_class($uploadUmbrellaSettlementsRequestCustomerIDItem) : sprintf('%s(%s)', gettype($uploadUmbrellaSettlementsRequestCustomerIDItem), var_export($uploadUmbrellaSettlementsRequestCustomerIDItem, true));
            }
        }
