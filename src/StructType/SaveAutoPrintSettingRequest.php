...
/**
 * This class stands for SaveAutoPrintSettingRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveAutoPrintSettingRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SaveAutoPrintSettingRequest
     * @uses SaveAutoPrintSettingRequest::setMidocoAutoPrintSetting()
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoAutoPrintSetting $midocoAutoPrintSetting
     * @return \Pggns\MidocoApi\Crm\StructType\SaveAutoPrintSettingRequest
     */
